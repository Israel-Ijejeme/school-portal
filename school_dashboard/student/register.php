...
// If already logged in and is student, redirect to dashboard
...
<head>
    ...
    <title>Student Registration - School Dashboard</title>
    <!-- Bootstrap CSS -->
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="age" name="age" min="15" max="100" value="<?php echo isset($age) ? $age : ''; ?>" required>
                    </div>
                </div>
