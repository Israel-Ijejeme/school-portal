                            ...
                            <tbody>
                                <?php foreach ($departments as $department): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_department.php?id=<?php echo $department['id']; ?>" class="btn btn-sm btn-primary">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form method="POST" action="delete_department.php" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this department?');">
