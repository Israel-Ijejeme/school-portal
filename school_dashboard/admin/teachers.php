                            ...
                            <tbody>
                                <?php foreach ($teachers as $teacher): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_teacher.php?id=<?php echo $teacher['id']; ?>" class="btn btn-sm btn-primary">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form method="POST" action="delete_teacher.php" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this teacher?');">
