        ...
        <div class="content">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Courses and Grades</h6>
                </div>
                <div class="card-body">
                    <?php if (empty($teacherCourses)): ?>
                        <div class="alert alert-info">
                            <p>You are not assigned to any courses. Please contact the administrator.</p>
                        </div>
                    <?php else: ?>
                                ...
                                <tbody>
                                    <?php foreach ($teacherCourses as $courseData): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="course_grades.php?course_id=<?php echo $courseData['id']; ?>" class="btn btn-sm btn-primary">
